jQuery.sap.declare("com.technovati.dev.devapp");
jQuery.sap.require("com.technovati.dev.devlogon");

com.technovati.dev.devapp = {
	smpInfo: {},
	externalURL: null,
	...
	onDeviceReady: function() {
		if (window.sap_webide_FacadePreview) {
			...
			var that = com.technovati.dev.devapp;
			$.getJSON(".project.json", function(data) {
				...
				if (that.smpInfo.server && that.smpInfo.server.length > 0) {
					...
					that.devLogon = new com.technovati.dev.devlogon();
