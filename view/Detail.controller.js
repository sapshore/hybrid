jQuery.sap.require("com.technovati.util.Formatter");
jQuery.sap.require("com.technovati.util.Controller");

com.technovati.util.Controller.extend("com.technovati.view.Detail", {
	...
	onRouteMatched: function(oEvent) {
		...
		jQuery.when(this.oInitialLoadFinishedDeferred).then(jQuery.proxy(function() {
			...
			oIconTabBar.getItems().forEach(function(oItem) {
				oItem.bindElement(com.technovati.util.Formatter.uppercaseFirstChar(oItem.getKey()));
			});
	...
	showEmptyView: function() {
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.technovati.view.NotFound",
			targetViewType: "XML"
		});
	},
